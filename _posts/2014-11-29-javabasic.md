...
上面的长篇大论实际上是要解释什么是"书"！在电影中是男主角用来讽刺教授的死板的。而实际上，仔细想来，我们所熟悉的任何东西都需要长篇大论来解释，有些词甚至难以解释！比如说：
...
和自然语言一样，编程语言也是对现实世界的抽象。自然语言是抽象给我们来认知，而编程语言则是抽象给计算机来认知。计算机擅长高频次简单计算
...
![](/home/ivan/my/teach/java/javase/01_basic/file/5.jpg)
