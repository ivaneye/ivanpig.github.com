...
这是维基百科上的答案！也是网上能得到的最多的答案！而这实际上根本不能算是面向对象思想。因为非面向对象语言也有此特性(后面介绍其它语言会讲到)，或者说普通得根本就不能算是特性了！！！

## 那么到底什么是面向对象思想呢？！

其实很简单，就是"对象"思想！面向对象思想中：将所有的东西都作为对象，所有的操作均是基于对象之上。以对象作为最小封装单位，以对象为单位进行交互，在对象之上实现了继承与多态。
